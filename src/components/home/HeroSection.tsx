...
export function HeroSection() {
  return (
    <section className="relative max-w-full overflow-hidden border-b border-[#04CA37]/30 bg-[#0a0a0a]">
      ...
      <div className="relative mx-auto max-w-7xl px-4 py-12 sm:px-6 sm:py-16 md:px-8 lg:px-12 lg:py-20">
        <div className="max-w-3xl">
          <SectionFolderLabel path={String.raw`C:\ZERO_BLOCK\SYSTEM\ROOT-EXECUTE PROTOCOL_V1.EXE`} />
          ...
          <p className="mt-6 max-w-2xl font-ibm text-base leading-[1.6] text-[#04CA37] sm:mt-8 sm:text-lg md:text-xl">
            Соревнуйся с тысячами разработчиков. Решай логические задачи на
            скорость и стань лидером сезона
          </p>
